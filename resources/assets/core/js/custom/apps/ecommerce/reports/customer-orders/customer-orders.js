...
var KTAppEcommerceReportCustomerOrders = function () {
    ...
    var exportButtons = () => {
        ...
        // Hook dropdown menu click event to datatable exports buttons
        const exportButtons = document.querySelectorAll('#kt_ecommerce_report_customer_orders_export_menu [data-kt-ecommerce-exports]');
        exportButtons.forEach(exportButton => {
            exportButton.addEventListener('click', e => {
                e.preventDefault();

                // Get clicked exports value
                const exportValue = e.target.getAttribute('data-kt-ecommerce-exports');
                const target = document.querySelector('.dt-buttons .buttons-' + exportValue);

                // Trigger click event on hidden datatable exports buttons
                target.click();
            });
        });
    }
